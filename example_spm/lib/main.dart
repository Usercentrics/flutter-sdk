...
import 'gpp_testing.dart';
import 'webview_integration.dart';

// Settings ID for the sample app — same one used by flutter-sdk/example.
// NOTE: consent mediation (Firebase-backed) is intentionally NOT ported here —
// it requires CocoaPods (pod 'FirebaseAnalytics' in example/ios/Podfile), which
// would defeat the purpose of this app: proving usercentrics_sdk works with
// zero CocoaPods involvement. See flutter-sdk/example for the mediation demo.
...
class HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Usercentrics SPM-Pure Sample'),
      ),
