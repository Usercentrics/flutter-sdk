...
class GetTCStringBridgeTest: XCTestCase, BaseBridgeTestProtocol {

    var bridgeName: String! = "getTCString"
    ...
    override func setUp() {
        ...
        bridge = GetTCStringBridge(usercentrics: FakeUsercentricsProxy(shared: usercentrics))
        super.setUp()
    }
    ...
    func testInvoke() {
        usercentrics.getTCStringData = "abc"
