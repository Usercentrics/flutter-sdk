...
internal object GetCMPDataMock {
    ...
    private val expectedSecondLayer = mapOf(
    ...
    private val expectedTCF2Settings = mapOf(
        ...
        "gdprApplies" to true,
        "consensuDomain" to null,
        "consensuScriptPath" to null,
    ...
    private val expectedCustomization = mapOf(
        "color" to mapOf(
            "primary" to "0045A5",
            "acceptBtnText" to null,
            "acceptBtnBackground" to null,
            "denyBtnText" to null,
            "denyBtnBackground" to null,
            "saveBtnText" to null,
            "saveBtnBackground" to null,
            "linkIcon" to null,
            "linkFont" to null,
            "text" to null,
            "layerBackground" to null,
            "overlay" to null,
            "toggleInactiveBackground" to null,
            "toggleInactiveIcon" to null,
            "toggleActiveBackground" to null,
        ...
        "borderRadiusLayer" to null,
        "useBackgroundShadow" to null,
        "borderRadiusButton" to null,
        "overlayOpacity" to null,
    )
    val expectedSettings = mapOf(
        "labels" to expectedLabels,
        "showInitialViewForVersionChange" to listOf<Any>(),
        "reshowBanner" to null,
