...
class ServiceSerializer {
  static UsercentricsService deserialize(dynamic value) {
    return UsercentricsService(
      ...
      cookieNames: value['cookieNames']?.cast<String>() ?? [],
      language: value['language'] ?? "",
      isLatest: value['isLatest'],
      isShared: value['isShared'],
      shareCustomConsent: value['shareCustomConsent'] ?? "",
      linkToDpa: value['linkToDpa'] ?? "",
      defaultConsentStatus: value['defaultConsentStatus'],
      ...
      dataPurposesDescription: value['dataPurposesDescription'] ?? "",
      legalBasisDescription: value['legalBasisDescription'] ?? "",
      optOutDescription: value['optOutDescription'] ?? "",
      thirdCountryTransfer: value['thirdCountryTransfer'] ?? "",
      defaultCategoryLabel: value['defaultCategoryLabel'] ?? "",
